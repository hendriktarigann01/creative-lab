    ...
    >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-x-4 top-[80px] bg-card/95 backdrop-blur-lg border border-border rounded-2xl p-6 shadow-xl flex flex-col gap-6 z-40 transition-all duration-300">
          ...
          <div className="flex gap-3 justify-center items-center py-2 border-t border-border">
            ...
            {locales.map((l) => (
              <button
                ...
                className={cn(
                  'flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-full border transition-all duration-200 cursor-pointer',
                  locale === l
