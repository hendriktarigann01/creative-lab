...
export function Contact({ hideHeader = false }: ContactProps) {
  ...
  return (
    <section
      ...
      className={
        hideHeader
          ? "py-8 flex flex-col items-center justify-center p-4 font-sans w-full relative overflow-hidden"
          : "py-24 sm:py-32 flex flex-col items-center justify-center p-4 font-sans w-full min-h-screen relative overflow-hidden"
      }
    >
      ...
      <Container className="flex flex-col items-center relative z-10">
        ...
        >
          <div className="flex flex-wrap justify-center gap-10 md:gap-14">
            ...
            >
              <div className="icon-container">
                <svg
                  ...
                  className="h-8 w-8 text-foreground transition-colors duration-300"
                >
            ...
            >
              <div className="icon-container">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-foreground transition-colors duration-300">
