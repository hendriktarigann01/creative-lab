...
export default function CTAProduct({ projectSlug, ctaData }: CTAProductProps) {
  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 md:px-6 bg-background">
      <div className="mx-auto max-w-7xl relative rounded-3xl border border-border overflow-hidden shadow-sm pt-6 md:pt-12 px-12 sm:px-16 md:px-20 flex flex-col items-center">
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          <AnimateOnScroll variant="slideUp" className="mt-8 delay-200">
            ...
            >
              <span className="text-sm font-light">{t('getConsultation') || 'Get Consultation'}</span>
          ...
          <AnimateOnScroll variant="slideUp" className="w-full mt-12 md:mt-16 delay-300">
            <div className="w-full overflow-hidden">
              <Image
                ...
                alt={t('dashboardPreview', { title: projectSlug }) || `${projectSlug} Dashboard Preview`}
                width={1920}
                height={1080}
