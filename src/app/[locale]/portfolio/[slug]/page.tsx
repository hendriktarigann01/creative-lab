...
import { ArrowLeft, CheckCircle2, Calendar, User, Briefcase, BarChart } from 'lucide-react';
...
export default function ProjectDetailPage() {
  ...
  return (
    <div className="bg-background min-h-screen pb-16 relative overflow-hidden flex flex-col items-center">
              ...
              <Card className="p-8 border border-border backdrop-blur-3xl bg-linear-to-br from-primary/5 via-accent/3 to-card flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex items-start gap-3 text-sm">
                    ...
                    <div>
                      <span className="block text-muted-foreground/60 uppercase text-[10px] font-bold tracking-wider">
                        {t('client')}
                      </span>
                ...
                <div className="border-t border-border pt-6 flex flex-col gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-muted border border-border rounded-lg text-xs font-semibold text-muted-foreground"
                      >
                        {tech}
                      </span>
                    ))}
      ...
      <div className="w-full relative z-10 mt-12 border-t border-border">
        <CTA />
      </div>
    </div>
  );
